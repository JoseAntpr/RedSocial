                ...
                <div class="row row-offcanvas row-offcanvas-left">
                    ...
                    <div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
                        ...
                        <ul class="nav hidden-xs" id="lg-menu"></br></br>
                            ...
                            <li><a href="ListarSeguidoresServlet?x=seguidores"><i class="glyphicon glyphicon-list"></i> Seguidores <b><%=usuario.getUsuarioCollection1().size()%></b>  </a></li>
                            <li><a href="ListarSeguidoresServlet?x=Seguir" name="Seguir" ><i class="glyphicon glyphicon-list"></i> Siguiendo <b><%=usuario.getUsuarioCollection().size()%> </b></a></li></br>
