							...
							<div class="full col-sm-9">
								...
								<div class="row">                                   
                                                                <form method="POST" action="NuevoUsuarioServlet">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                    <input type="text" name="nombre" placeholder="<%= u.getNombre() %>"  class="form-control" required autofocus></br>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                    <input type="text" name="apellidos" placeholder="<%= u.getApellidos()%>"  class="form-control" required autofocus></br>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                    <input type="text" name="direccion" placeholder="<%= u.getDireccion()%>"  class="form-control" required autofocus></br>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                    <input type="text" name="localidad" placeholder="<%= u.getLocalidad()%>"  class="form-control" required autofocus></br>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                    <input type="text" name="provincia" placeholder="<%= u.getProvincia()%>"  class="form-control" required autofocus></br>
                                                                    </div>
                                                                    <div class="col-sm-4">
                                                                    <input type="text" name="pais" placeholder="<%= u.getPais()%>"  class="form-control" required autofocus></br>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                    <input type="text" name="email" placeholder="<%= u.getEmail()%>"  class="form-control" required autofocus></br>
                                                                    </div>
                                                                    <div class="col-sm-6">
                                                                    <input type="password" id="password" name="password" class="form-control" placeholder="<%= u.getPassword()%>" required></br>
                                                                    </div>
                                                                    <div class="col-sm-4">
